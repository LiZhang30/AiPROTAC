...
def build_dataset(dir):
    targetGraphs, _ = load_graphs(dir+"TargetPocketGraphs_8A.bin")
    warheadGraphs, _ = load_graphs(dir+"WarheadGraphs.bin")
    e3ligandGraphs, _ = load_graphs(dir+"E3ligandGraphs.bin")
    e3ligaseGraphs, _ = load_graphs(dir+"LigasePocketGraphs_8A.bin")
...
def main(args):
    ...
    with th.no_grad():
        ...
        predictor.eval()
        predictor.load_state_dict(th.load('1 DeepPROTACs-seed1 final_model.pth'))
