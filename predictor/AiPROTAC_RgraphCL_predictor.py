...
from model.AiPROTAC_RgraphCL import DatasetIterater, Gcollate, GraphBasedModel
...
def main(args):
    ...
    with th.no_grad():
        ...
        predictor.eval()
        predictor.load_state_dict(th.load('1 AiPROTACs-RgraphCL-seed1 final_model.pth'))
