...
from model.AiPROTAC import DatasetIterater, Gcollate, GraphBasedModel
...
def parse_args():
    ...
    parser.add_argument("--data_dir", type=str, default="../data/self-built dataset/", help="Dataset directory.")
...
def main(args):
    ...
    with th.no_grad():
        ...
        predictor.eval()
        predictor.load_state_dict(th.load('1 AiPROTACs-seed1 final_model.pth'))
